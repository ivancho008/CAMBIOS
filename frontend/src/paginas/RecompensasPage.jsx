  ...
  const [recompensas] = useState([
    {
      ...
      descripcion: 'Completa 50 sesiones de Pomodoro',
      tipo: 'tecnica',
      valor: 100,
      requisitos: { sesiones_pomodoro: 50 }
    },
    {
      id_recompensa: '2',
      nombre: 'Organizador Experto',
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div
                    className={`inline-block px-2 py-1 rounded-full text-xs ${getTipoColor(
                      r.tipo
                    )}`}
                  >
                    {r.tipo}
            ...
            {r.requisitos && (
              <div className="mb-4">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  {Object.entries(r.requisitos).map(([k, v]) => (
